class ProductsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @product.update(product_params)
        format.html { redirect_to manager_products_path, notice: 'Product was successfully updated.' }
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :model, :seller, :price, :picture, :description)
    end
end
